          ...
          <div className="max-w-7xl mx-auto px-6 py-12">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="relative">
                <img
                  src={superHv?.image || '/placeholder.svg'}
                  alt={superHv?.alias}
                  width={200}
                  height={200}
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-xl text-blue-200 mb-4">{superHv?.name}</p>
                  ...
                  <div className="flex justify-center mt-2">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-4 h-4 ${
                          i < Math.floor(averagePower(superHv) / 20)
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="text-center">
                  <CardContent className="pt-6">
                    ...
                    <Progress value={superHv.strength * 10} className="h-2" />
                  </CardContent>
                </Card>
                ...
                <Card className="text-center">
                  <CardContent className="pt-6">
                    ...
                    <Progress value={superHv.speed * 10} className="h-2" />
                  </CardContent>
                </Card>
                ...
                <Card className="text-center">
                  <CardContent className="pt-6">
                    ...
                    <Progress value={superHv.durability * 10} className="h-2" />
                  </CardContent>
                </Card>
              </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {superHv.powers.map((power, index) => (
                      <div
                        key={index}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between items-center py-2 border-b">
                      ...
                      <span className="font-semibold">{superHv.name}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b">
                      <span className="text-gray-600">Alias:</span>
                      <span className="font-semibold">{superHv.alias}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between items-center py-2 border-b">
                      ...
                      <span className="font-semibold">{superHv.universe}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b">
                      <span className="text-gray-600">Primera Aparición:</span>
                      <span className="font-semibold">
                        {superHv.firstAppearance}
                      </span>
                    </div>
                    <div className="flex justify-between items-center py-2">
                      ...
                      <span className="font-semibold">
                        {new Date().getFullYear() -
                          Number.parseInt(superHv.firstAppearance)}{' '}
                        años
                      </span>
                    </div>
                  </CardContent>
